...
public partial class @Controls : IInputActionCollection2, IDisposable
{
    ...
    public struct DebugActions
    {
        ...
        public void SetCallbacks(IDebugActions instance)
        {
            ...
            {
                @FPSMonitor.started -= m_Wrapper.m_DebugActionsCallbackInterface.OnFPSMonitor;
                @FPSMonitor.performed -= m_Wrapper.m_DebugActionsCallbackInterface.OnFPSMonitor;
                @FPSMonitor.canceled -= m_Wrapper.m_DebugActionsCallbackInterface.OnFPSMonitor;
                @ToggleHUD.started -= m_Wrapper.m_DebugActionsCallbackInterface.OnToggleHUD;
                @ToggleHUD.performed -= m_Wrapper.m_DebugActionsCallbackInterface.OnToggleHUD;
                @ToggleHUD.canceled -= m_Wrapper.m_DebugActionsCallbackInterface.OnToggleHUD;
            }
