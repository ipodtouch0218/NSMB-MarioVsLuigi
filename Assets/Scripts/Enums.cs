...
public static class Enums {
    ...
    public enum Sounds : byte {
        ...
        [SoundData("player/powerup")]                   Player_Sound_PowerupCollect = 16,
        ...
        [SoundData("powerup/megamushroom_break_block")] Powerup_MegaMushroom_Break_Block,
        [SoundData("powerup/megamushroom_break_pipe")]  Powerup_MegaMushroom_Break_Pipe,
        [SoundData("powerup/megamushroom_collect")]     Powerup_MegaMushroom_Collect = 40,
        ...
        [SoundData("powerup/megamushroom_walk")]        Powerup_MegaMushroom_Walk,
        [SoundData("powerup/minimushroom_collect")]     Powerup_MiniMushroom_Collect = 45,
