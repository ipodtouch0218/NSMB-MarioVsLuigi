...
namespace NSMB.UI.MainMenu.Submenus.Prompts {
    ...
    public class GameSettingsPromptSubmenu : PromptSubmenu, IInRoomCallbacks {
        ...
        [SerializeField] private List<GameSettingsPromptTab> tabs;
        ...
        public void UpdateDescription(CommandChangeRules.Rules ruleType) {
            string key = ruleTranslationKeys.FirstOrDefault(rtk => rtk.Rule == ruleType)?.TranslationKey ?? "";
            descriptionText.text = GlobalController.Instance.translationManager.GetTranslation(key);
        ...
        [Serializable]
        public class GameSettingsPromptTab {
