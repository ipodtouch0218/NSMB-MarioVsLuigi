...
namespace NSMB.Utils {
    public static class Layers {
        ...
        private static int? _layerGround, _layerHitsNothing, _layerDefault, _layerPassthrough, _layerLooseCoin, _layerEntity, _layerEntityHitbox, _layerPlayer, _layerIceBlock;
