...
namespace Quantum {
    ...
    public unsafe partial struct FrameEvents {
      ...
      static partial void GetEventTypeCodeGen(Int32 eventID, ref System.Type result) {
        switch (eventID) {
          ...
          case EventMarioPlayerPickedUpGoldBlockHelmet.ID: result = typeof(EventMarioPlayerPickedUpGoldBlockHelmet); return;
          case EventGoldBlockHelmetGeneratedObjectiveCoin.ID: result = typeof(EventGoldBlockHelmetGeneratedObjectiveCoin); return;
          case EventMarioPlayerLostGoldBlockHelmet.ID: result = typeof(EventMarioPlayerLostGoldBlockHelmet); return;
      ...
      public EventMarioPlayerPickedUpGoldBlockHelmet MarioPlayerPickedUpGoldBlockHelmet(EntityRef Entity, EntityRef Helmet) {
        var ev = _f.Context.AcquireEvent<EventMarioPlayerPickedUpGoldBlockHelmet>(EventMarioPlayerPickedUpGoldBlockHelmet.ID);
        ev.Entity = Entity;
        ev.Helmet = Helmet;
        _f.AddEvent(ev);
        return ev;
      }
      public EventGoldBlockHelmetGeneratedObjectiveCoin GoldBlockHelmetGeneratedObjectiveCoin(EntityRef Helmet) {
        var ev = _f.Context.AcquireEvent<EventGoldBlockHelmetGeneratedObjectiveCoin>(EventGoldBlockHelmetGeneratedObjectiveCoin.ID);
        ev.Helmet = Helmet;
        _f.AddEvent(ev);
        return ev;
      }
      public EventMarioPlayerLostGoldBlockHelmet MarioPlayerLostGoldBlockHelmet(EntityRef Entity) {
        if (_f.IsPredicted) return null;
        var ev = _f.Context.AcquireEvent<EventMarioPlayerLostGoldBlockHelmet>(EventMarioPlayerLostGoldBlockHelmet.ID);
        ev.Entity = Entity;
        _f.AddEvent(ev);
        return ev;
      }
  ...
  public unsafe partial class EventMarioPlayerPickedUpGoldBlockHelmet : EventBase {
    public new const Int32 ID = 38;
    public EntityRef Entity;
    public EntityRef Helmet;
    protected EventMarioPlayerPickedUpGoldBlockHelmet(Int32 id, EventFlags flags) : 
        base(id, flags) {
    }
    public EventMarioPlayerPickedUpGoldBlockHelmet() : 
    ...
    public override Int32 GetHashCode() {
      unchecked {
        var hash = 229;
        hash = hash * 31 + Entity.GetHashCode();
        hash = hash * 31 + Helmet.GetHashCode();
        return hash;
      }
    }
  }
  public unsafe partial class EventGoldBlockHelmetGeneratedObjectiveCoin : EventBase {
    public new const Int32 ID = 39;
    public EntityRef Helmet;
    protected EventGoldBlockHelmetGeneratedObjectiveCoin(Int32 id, EventFlags flags) : 
        base(id, flags) {
    }
    public EventGoldBlockHelmetGeneratedObjectiveCoin() : 
  ...
  public unsafe partial class EventMarioPlayerLostGoldBlockHelmet : EventBase {
    public new const Int32 ID = 40;
    public EntityRef Entity;
    protected EventMarioPlayerLostGoldBlockHelmet(Int32 id, EventFlags flags) : 
        base(id, flags) {
    }
    public EventMarioPlayerLostGoldBlockHelmet() : 
